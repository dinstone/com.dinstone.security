...
public class ExceptionHandlerController {
    ...
    /**
     * @ExceptionHandler(NullPointerException.class) public ModelAndView error(ModelAndView mav) {
     *                                               mav.setViewName("error"); 　　　　mav.addObject("param",
     *                                               "NullPointer error"); return mav; }
     */
